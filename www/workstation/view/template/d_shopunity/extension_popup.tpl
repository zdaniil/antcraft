<div class="extension-popup" id="extension_popup_<?php echo $extension['codename']; ?>">
		...
		<ul class="nav nav-tabs" style="border-bottom: none;" role="tablist">
			<?php if(!empty($extension['required'])){?><li role="presentation" style="margin: 10px;" class="active"><a href="#dependencies" aria-controls="dependencies" role="tab" data-toggle="tab">Dependencies</a></li><?php } ?>
