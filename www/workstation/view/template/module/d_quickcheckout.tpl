                                    ...
                                    <div class="col-sm-10">
                                        <div class="tab-content">
                                            ...
                                            <div id="d_design" class="tab-pane">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" >
                                                        <span data-toggle="tooltip" title="" data-original-title="<?php echo $help_design_telephone_countries; ?>"><?php echo $entry_design_telephone_countries; ?></span>
                                                    </label>
                                                    <div class="col-sm-9">
                                                        <input id="cart_image_size_width" name="<?php echo $id; ?>_setting[design][telephone_countries]" value="<?php echo (isset($setting['design']['telephone_countries'])) ? $setting['design']['telephone_countries'] : ' '; ?>" class="form-control"/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" >
                                                        <span data-toggle="tooltip" title="" data-original-title="<?php echo $help_design_telephone_preferred_countries; ?>"><?php echo $entry_design_telephone_preferred_countries; ?></span>
                                                    </label>
                                                    <div class="col-sm-9">
                                                        <input id="cart_image_size_width" name="<?php echo $id; ?>_setting[design][telephone_preferred_countries]" value="<?php echo (isset($setting['design']['telephone_preferred_countries'])) ? $setting['design']['telephone_preferred_countries'] : ' '; ?>" class="form-control"/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="input-catalog-limit">
                                                        <span data-toggle="tooltip" title="<?php echo $help_design_telephone_validation; ?>">
                                                            <?php echo $entry_design_telephone_validation ?>
                                                        </span>
                                                    </label>
                                                    <div class="col-sm-9">
                                                        <input type="hidden" value="0" name="<?php echo $id; ?>_setting[design][telephone_validation]" />
                                                        <input type="checkbox" value="1" data-label-text="<?php echo $text_enable; ?>" name="<?php echo $id; ?>_setting[design][telephone_validation]" <?php echo (isset($setting['design']['telephone_validation']) && $setting['design']['telephone_validation'])? 'checked="checked"' : ''; ?> id="design_telephone_validation" />
                                                    </div>
                                                </div>
...
<script type="text/javascript"><!--
    ...
    $(function () {
        ...
        $('#select_config_submit').on('click', function(){
            ...
            $('#content').append('<form action="<?php echo $module_link; ?><?php echo ($stores) ? "&store_id=' + store_id + '" : ''; ?><?php echo ($setting_id) ? "&setting_id=' + setting_id + '" : ''; ?>" id="config_update" method="post" style="display:none;"><input type="text" name="config" value="' + config + '" /><input type="text" name="setting_id" value="' + setting_id + '" /></form>');
