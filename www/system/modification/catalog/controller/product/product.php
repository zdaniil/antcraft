	...
	public function index() {
		...
		if ($product_info) {
			...
			foreach ($results as $result) {
				...
				$data['images'][] = array(
					'popup' => $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . 'config_image_popup_width'), $this->config->get($this->config->get('config_theme') . 'config_image_popup_height')),
					'thumb' => $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . 'config_image_thumb_width'), $this->config->get($this->config->get('config_theme') . 'config_image_thumb_height'))
				);
