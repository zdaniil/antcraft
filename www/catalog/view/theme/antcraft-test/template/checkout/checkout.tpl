...
<div class="container">        
		...
		<div class="row">
			<div class="col-md-12">
			    ...
			    <p id="rf3" class="well"><?php echo $text_returning_customer; ?> &nbsp;<a href="#" onclick="jQuery('.login-form').toggle();return false;"/><?php echo $text_i_am_returning_customer; ?></a></p>
			    <script>
			    		jQuery('#rf3').click(function() {
			    			jQuery('#mshider').toggle();
			    		});
			    </script>
				...
				<div class="form-group col-md-4">
				    ...
				    <a style="float: left;" href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a>
				</div>
			      </form>
			    </div>
			</div>
		...
		<div id="mshider" class="row box checkout_form">
			...
			<div class="shiptobilling clearfix">
					...
					<?php if (!isset($customer_id)) {?>
				   <!--HERE--> <label style="display:none;" class="checkbox">
			   ...
			   <?php //}?>
				...
				<div class="your_order">
					...
					<div class="payment clearfix">
					    ...
					    <input type="button" style="margin-bottom: 10px;" class="btn btn-primary" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" id="button-register" value="<?php echo $heading_title;?>">
					    <?php }?></div>
					</div>
			    </div>
			</div>
