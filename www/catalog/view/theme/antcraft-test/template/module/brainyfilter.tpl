...
<div class="bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>">
    ...
    <div class="box bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
        ...
        <div class="catalog-sidebar brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
            <form class="bf-form
                ...
                <?php foreach ($filters as $i => $section) : ?>
                    ...
                    <?php if ($section['type'] == 'price') : ?>
                        ...
                        <div class="option-title<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                        ...
                        <div class="bf-attr-block-cont">
                            ...
                            <div class="check-box">
                                <div class="bf-cell">
                                    <select name="<?php echo "bfp_{$groupUID}"; ?>">
                                        <option value="" class="bf-default checkbox-id"><?php echo $default_value_select; ?></option>
                            ...
                            <?php else : ?>
                                ...
                                <div class="check-box">
                                        ...
                                        <label class="bf-cell bf-c-2 bf-cascade-<?php echo $cat['level']; ?> check" for="bf-attr-<?php echo $groupUID . '_' . $catId . '_' . $layout_id; ?>"></label>
                                        <label class="title" for="bf-attr-<?php echo $groupUID . '_' . $catId . '_' . $layout_id; ?>">
                                            <?php echo $cat['name']; ?>
                                        </label>
                            ...
                            <div class="bf-attr-block-cont">
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="check-box">
                                        ...
                                        <label class="bf-cell bf-c-2 <?php if ($section['type'] == 'rating') echo 'bf-rating-' . $valueId; ?> check" for="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"></label>

                                            <label class="title" for="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>">
                ...
                <?php endforeach; ?>
                <?php if (!$isHorizontal || $settings['submission']['submit_type'] == 'button') : ?><div class="bf-buttonclear-box" style="margin-bottom:10px;"><?php if ($isHorizontal && $settings['submission']['submit_button_type'] == 'float') : ?>style="display:none;"<?php endif; ?>>
                         <input type="button" value="<?php echo $lang_submit; ?>" class="bf-buttonsubmit" onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;" <?php if ($settings['submission']['submit_button_type'] != 'fix' && $settings['submission']['submit_type'] != 'button' )  : ?>style="display:none;" <?php endif; ?> />
                   <?php if (!$isHorizontal) : ?><input type="reset" class="bf-buttonclear" onclick="BrainyFilter.reset();return false;" value="ОЧИСТИТЬ ФИЛЬТР" /><?php endif; ?>
                </div><?php endif; ?>
            </form>
        </div>
    </div>
